# imports
from social_distancing_detector.configs import config
from social_distancing_detector.configs.detection import detect_people
...
def detectdis():
    ...
    ap.add_argument("-o", "--output", type=str, default="./social_distancing_detector/outdefault3.avi",
    ...
    while True:
        ...
        results = detect_people(
            frame, net, ln, personIdx=LABELS.index("person"))
        ...
        for (i, (prob, bbox, centroid)) in enumerate(results):
            ...
            cv2.circle(frame, (cX, cY), 5, (120, 110, 110), 1)

        # draw the total number of social distancing violations on the output frame
        text = "Social Distancing Violations: {}".format(len(violate))
        cv2.putText(
            frame, text, (10, frame.shape[0] - 25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
